...
def main(args):
    ...
    #             "labels": labels,
    #         },
    #         "{}/{}/{}_{}_HF.pt".format(args.EXP_FOLDER, args.dataset, name, str(args.model).replace("/", "_")),
    #     )
    #     if args.all:
    #         torch.save(
    #             {
    ...
    #                 "labels": labels,
    #             },
    #             "{}/{}/{}_{}_HF_All.pt".format(args.EXP_FOLDER, args.dataset, name, str(args.model).replace("/", "_")),
    #         )
